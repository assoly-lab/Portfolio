        ...
        <>
            ...
            <div className="w-[90%] md:w-[80%] h-24 flex justify-between items-center flex-row-reverse md:flex-row text-2xl py-4 cursor-pointer" >
                ...
                <div className="left md:flex gap-8 text-xl hidden" >
                    <Link href={'#skills'} className="relative text-gray-500 dark:text-white transition-all duration-300 hover:text-[#8A3FFC] group" >Skills
                        <span className="absolute left-0 -bottom-1 w-0 h-[4px] bg-[#8A3FFC] dark:bg-white group-hover:w-full transition-all duration-300"></span>
                    </Link>
                    <Link href={'#projects'} scroll className="relative text-gray-500 dark:text-white transition-all duration-300 hover:text-[#8A3FFC] group" >Projects
                        <span className="absolute left-0 -bottom-1 w-0 h-[4px] bg-[#8A3FFC] dark:bg-white group-hover:w-full transition-all duration-300"></span>
                    </Link>
                    <Link href={'#contact'} className="relative text-gray-500 dark:text-white transition-all duration-300 hover:text-[#8A3FFC] group" >Contact
                        <span className="absolute left-0 -bottom-1 w-0 h-[4px] bg-[#8A3FFC] dark:bg-white group-hover:w-full transition-all duration-300"></span>
                    </Link>    
